...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/mes-candidatures', [MesCandidaturesController::class, 'index'])
        ...
        ->name('mes-candidatures.index');

    Route::get('/mes-candidatures/{candidature}', [MesCandidaturesController::class, 'show'])

        ->name('mes-candidatures.show');

    // CV (lecture/téléchargement) : réutilise le contrôleur Admin/CandidatureController
    Route::get('/mes-candidatures/{candidature}/cv', [MesCandidaturesController::class, 'cv'])
        ->name('mes-candidatures.cv');
