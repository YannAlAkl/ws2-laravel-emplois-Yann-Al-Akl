...
@section('title', 'Modifier — ' . $offreEmploi->titre)
...
<div class="min-h-screen bg-slate-50">
    ...
    <div class="max-w-3xl mx-auto px-6 py-10">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-[#1E2D4A]">Modifier l'offre</h1>
            <p class="text-slate-500 mt-1">{{ $offreEmploi->titre }}</p>
        </div>
        ...
        <form action="{{ route('admin.offres.update', $offreEmploi->id) }}" method="POST"
